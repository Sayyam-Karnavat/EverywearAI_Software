...
class ToastNotification(QWidget):
    def __init__(self, message, parent=None):
        ...
        self.show()
        self.animate_show()
        self.timer.start(2000)  # Hide after 2 seconds
...
class PromptViewerDialog(QDialog):
    ...
    def init_ui(self):
        ...
        # Right side layout for content viewer and copy button
    ...
    def show_file_content(self, item):
        ...
        try:
            with open(file_path, 'r') as file:
                ...
                self.copy_button.setEnabled(True)  # Enable copy button when content is loaded
        except Exception as e:
...
class FloatingIcon(QWidget):
    def __init__(self, icon_path):
        ...
        # Position the icon higher to avoid taskbar clash
        # Changed from screen_geometry.height() - 100 to screen_geometry.height() - 180
