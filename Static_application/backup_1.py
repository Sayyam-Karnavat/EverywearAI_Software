...
class FloatingBrowser(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.prompt_button.setStyleSheet("background-color: #0d846b; color: white; border-radius: 10px; padding: 5px;")
        
        self.size_button = QPushButton("Size")
        self.size_button.setStyleSheet("background-color: #0b6d58; color: white; border-radius: 10px; padding: 5px;")
        ...
        # Create a horizontal layout for submenu buttons
